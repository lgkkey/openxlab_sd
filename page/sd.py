...
def down_back_model():
    ...
    os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://hf-mirror.com/Laxhar/Freeway_Animation_HunYuan_Demo/resolve/main/freeway_demo_ema_model/mp_rank_00_model_states.pt -d /home/xlab-app-center/stable-diffusion-webui/models/Stable-diffusion -o mp_rank_00_model_states.pt")
